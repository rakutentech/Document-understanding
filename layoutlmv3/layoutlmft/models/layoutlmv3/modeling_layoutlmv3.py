...
class LayoutLMv3Model(LayoutLMv3PreTrainedModel):
    ...
    def forward(
        ...
        if not self.image_only:
            ...
            if self.config.sort_flag or self.config.PE_type in [2, 5, 6,
                                                                7] or self.config.cell_emb or self.config.norm_coor:
                cell_inputs = []
                cell_coor_inputs = []
                ...
                for sample in bbox.cpu().numpy():
                    ...
                    cell_coordinates, cell_no = create_cell_layout_4_layoutlm(new_bboxes, 1000, 1000,
            ...
            if self.config.norm_coor:
                #                 bbox = cell_coors
                # only update left-upper coordinate
