...
class LayoutLMv2Embeddings(nn.Module):
    ...
    def __init__(self, config):
        ...
        self.row_position_embeddings = nn.Embedding(1024, config.coordinate_size)
        self.col_position_embeddings = nn.Embedding(1024, config.coordinate_size)
    ...
    def _cal_spatial_position_embeddings(self, bbox, cell=None):
        try:
...
class LayoutLMv2Model(LayoutLMv2PreTrainedModel):
    ...
    def _calc_text_embeddings(self, input_ids, bbox, position_ids, token_type_ids,cell=None):
        ...
        spatial_position_embeddings = self.embeddings._cal_spatial_position_embeddings(bbox, cell)
    ...
    def _calc_img_embeddings(self, image, bbox, position_ids,cell=None):
